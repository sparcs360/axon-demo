...
public class DistributedEventBusAmqpConfig {
    ...
    @Autowired
    public void configure(EventHandlingConfiguration config, SpringAMQPMessageSource source) {

        config.registerSubscribingEventProcessor("com.sparcs.counter.kiosk", c -> source);
    }
}
